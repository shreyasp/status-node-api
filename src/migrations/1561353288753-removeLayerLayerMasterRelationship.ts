...
export class removeLayerLayerMasterRelationship1561353288753 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `ALTER TABLE "layer" ADD CONSTRAINT "FK_4183f15ac4502b4fae4f025b483" FOREIGN KEY ("layerMasterEntId", "layerMasterLayerMasterId") REFERENCES "layer_master"("EntId","layerMasterId") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
}
